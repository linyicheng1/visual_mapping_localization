...
namespace VISUAL_MAPPING {
     ...
     * @param map
     */
    void MapSaver::save_map(const std::string& filename, const std::vector<Frame> &frames, const Map &map) {
        std::fstream file;
    ...
    void MapSaver::load_map(const std::string &filename, std::vector<Frame> &frames, Map &map) {
        std::fstream file;
